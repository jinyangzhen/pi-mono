...
export async function buildTianSystemPrompt(params: BuildSystemPromptParams): Promise<string> {
...
function buildIdentitySection(user: TianUser): string {
...
function buildTaskSection(taskName?: string, taskDescription?: string, taskTemplate?: TaskTemplate): string {
...
function buildLongRunningSection(): string {
...
function formatRole(role: TianUser["role"]): string {
	const roleMap: Record<TianUser["role"], string> = {
		engineer: "Engineer",
